...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionFloats,              filament_bridge_pa))
    ((ConfigOptionFloats,              filament_bridge_internal_pa))
    ((ConfigOptionFloats,              filament_brim_pa))
    ...
    ((ConfigOptionFloats,              filament_external_perimeter_pa))
    ((ConfigOptionPercents,            filament_fill_top_flow_ratio))
    ((ConfigOptionPercents,            filament_first_layer_flow_ratio))
    ((ConfigOptionFloats,              filament_first_layer_pa))
    ((ConfigOptionFloats,              filament_first_layer_pa_over_raft))
    ((ConfigOptionFloats,              filament_gap_fill_pa))
    ((ConfigOptionFloats,              filament_infill_pa))
    ((ConfigOptionFloats,              filament_ironing_pa))
    ...
    ((ConfigOptionFloats,              filament_overhangs_pa))
    ((ConfigOptionFloats,              filament_perimeter_pa))
    ...
    ((ConfigOptionFloats,              filament_support_material_interface_pa))
    ((ConfigOptionFloats,              filament_thin_walls_pa))
    ((ConfigOptionFloats,              filament_toolchange_delay))
    ((ConfigOptionFloats,              filament_top_solid_infill_pa))
    ((ConfigOptionStrings,             filament_type))
    ((ConfigOptionFloats,              filament_travel_pa))
