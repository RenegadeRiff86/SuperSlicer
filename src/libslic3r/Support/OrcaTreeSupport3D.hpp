...
#ifndef slic3r_OrcaTreeSupport3D_hpp
#define slic3r_OrcaTreeSupport3D_hpp
...
struct AreaIncreaseSettings
{
    AreaIncreaseSettings(
        OrcaTreeModelVolumes::AvoidanceType type = OrcaTreeModelVolumes::AvoidanceType::Fast, coord_t increase_speed = 0, 
    ...
    OrcaTreeModelVolumes::AvoidanceType type;
 ...
 */
[[nodiscard]] inline size_t getEffectiveDTT(const OrcaTreeSupportSettings &settings, const SupportElementState &elem)
{
 ...
 */
[[nodiscard]] inline coord_t support_element_radius(const OrcaTreeSupportSettings &settings, const SupportElementState &elem)
{ 
 ...
 */
[[nodiscard]] inline coord_t support_element_collision_radius(const OrcaTreeSupportSettings &settings, const SupportElementState &elem)
{
...
[[nodiscard]] inline coord_t support_element_radius(const OrcaTreeSupportSettings &settings, const SupportElement &elem)
{
    return support_element_radius(settings, elem.state);
}

[[nodiscard]] inline coord_t support_element_collision_radius(const OrcaTreeSupportSettings &settings, const SupportElement &elem)
{
...
#endif /* slic3r_OrcaTreeSupport3D_hpp */
