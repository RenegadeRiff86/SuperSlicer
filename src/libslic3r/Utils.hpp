///|/ Copyright (c) Prusa Research 2016 - 2023 Oleksandra Iushchenko @YuSanka, Vojtěch Bubník @bubnikv, Filip Sykala @Jony01, David Kocík @kocikdav, Enrico Turri @enricoturri1966
///|/ Tomáš Mészáros @tamasmeszaros, Lukáš Matěna @lukasmatena, Vojtěch Král @vojtechkral
...
// Standard "generated by Slic3r version <version> timestamp <timestamp>" header string, 
// to be placed at the top of Slic3r generated files.
std::string header_slic3r_generated();

// Standard "generated by PrusaGCodeViewer version <version> timestamp <timestamp>" header string, 
// to be placed at the top of Slic3r generated files.
...
{
    const INDEX_TYPE quotient  = dividend / divisor;
    const INDEX_TYPE remainder = dividend % divisor;
...
inline std::string get_time_dhm(float time_in_secs)
{
    ...
    // Note: rough estimate only; it ignores the hash table size and the per-bin linked lists.
