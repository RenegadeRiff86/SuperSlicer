...
static constexpr int GRID_GAP = 5;
...
{
    wxFlexGridSizer* grid_sizer = new wxFlexGridSizer(3, GRID_GAP, GRID_GAP);
...
#endif
    wxFlexGridSizer* grid_sizer = new wxFlexGridSizer(9, GRID_GAP, GRID_GAP);
    sizer->Add(grid_sizer, 0, wxEXPAND);
    ...
    m_entries(entries)
{
    ...
    auto grid_sizer = new wxFlexGridSizer(3, DIALOG_PADDING, DIALOG_PADDING);

    auto main_sizer = new wxBoxSizer(wxVERTICAL);
    main_sizer->Add(grid_sizer, 0, wxEXPAND | wxALL, DIALOG_PADDING);
    ...
    main_sizer->Add(sizer, 0, wxEXPAND | wxALL, DIALOG_PADDING);
    ...
    main_sizer->Add(mode_sizer, 0, wxEXPAND | wxALL, DIALOG_PADDING);
