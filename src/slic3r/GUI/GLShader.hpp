...
{
    static constexpr size_t Vec2Components = 2;
    static constexpr size_t Vec3Components = 3;
    static constexpr size_t Vec4Components = 4;
...
public:
    ...
    void set_uniform(const char* name, const std::array<int, Vec2Components>& value) const { set_uniform(get_uniform_location(name), value); }
    void set_uniform(const char* name, const std::array<int, Vec3Components>& value) const { set_uniform(get_uniform_location(name), value); }
    void set_uniform(const char* name, const std::array<int, Vec4Components>& value) const { set_uniform(get_uniform_location(name), value); }
    void set_uniform(const char* name, const std::array<float, Vec2Components>& value) const { set_uniform(get_uniform_location(name), value); }
    void set_uniform(const char* name, const std::array<float, Vec3Components>& value) const { set_uniform(get_uniform_location(name), value); }
    void set_uniform(const char* name, const std::array<float, Vec4Components>& value) const { set_uniform(get_uniform_location(name), value); }
    void set_uniform(const char* name, const std::array<double, Vec4Components>& value) const { set_uniform(get_uniform_location(name), value); }
    ...
    void set_uniform(int id, const std::array<int, Vec2Components>& value) const;
    void set_uniform(int id, const std::array<int, Vec3Components>& value) const;
    void set_uniform(int id, const std::array<int, Vec4Components>& value) const;
    void set_uniform(int id, const std::array<float, Vec2Components>& value) const;
    void set_uniform(int id, const std::array<float, Vec3Components>& value) const;
    void set_uniform(int id, const std::array<float, Vec4Components>& value) const;
    void set_uniform(int id, const std::array<double, Vec4Components>& value) const;
