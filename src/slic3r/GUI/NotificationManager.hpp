// |/ Copyright (c) Prusa Research 2020 - 2023 David Kocík @kocikdav, Lukáš Matěna @lukasmatena, Pavel Mikuš @Godrak, Filip Sykala @Jony01, Vojtěch Bubník @bubnikv, Tomáš Mészáros @tamasmeszaros, Lukáš Hejl @hejllukas, Oleksandra Iushchenko @YuSanka,
...
inline constexpr size_t DEFAULT_COLLAPSED_LINE_COUNT = 2;
inline constexpr size_t PROGRESS_NOTIFICATION_DURATION_SECONDS = 2;
inline constexpr size_t DEFAULT_NOTIFICATION_DURATION_SECONDS = 10;
...
private:
    ...
    protected:
        ...
        static constexpr ButtonSlot ActionSlot { 5.0f,  4.625f, 2.f,    false, "  " }; // Hitbox width is two line heights.
        ...
        static constexpr float MinimizeBandLines = 2.f; // Minimize control occupies two text lines.
        ...
        size_t           m_normal_lines_count { DEFAULT_COLLAPSED_LINE_COUNT }; 
    ...
    size_t get_standard_duration(NotificationLevel level)
    {
        ...
        case NotificationLevel::ProgressBarNotificationLevel:		return PROGRESS_NOTIFICATION_DURATION_SECONDS;
        case NotificationLevel::PrintInfoShortNotificationLevel:	return 5;
        case NotificationLevel::RegularNotificationLevel: 			return DEFAULT_NOTIFICATION_DURATION_SECONDS;
        case NotificationLevel::PrintInfoNotificationLevel:			return DEFAULT_NOTIFICATION_DURATION_SECONDS;
        case NotificationLevel::HintNotificationLevel:				return 300;
        default: return DEFAULT_NOTIFICATION_DURATION_SECONDS;
        }
    }
    ...
    {NotificationType::Mouse3dDisconnected, NotificationLevel::RegularNotificationLevel, DEFAULT_NOTIFICATION_DURATION_SECONDS,  _u8L("3D Mouse disconnected.") },
    ...
    {NotificationType::EmptyColorChangeCode, NotificationLevel::PrintInfoNotificationLevel, DEFAULT_NOTIFICATION_DURATION_SECONDS,
        _u8L("You have just added a G-code for color change, but its value is empty.\n"
             "To export the G-code correctly, check the \"Color Change G-code\" in \"Printer Settings > Custom G-code\"") },
    {NotificationType::EmptyAutoColorChange, NotificationLevel::PrintInfoNotificationLevel, DEFAULT_NOTIFICATION_DURATION_SECONDS,
        _u8L("No color change event was added to the print. The print does not look like a sign.") },
    {NotificationType::DesktopIntegrationSuccess, NotificationLevel::RegularNotificationLevel, DEFAULT_NOTIFICATION_DURATION_SECONDS,
        _u8L("Desktop integration was successful.") },
    {NotificationType::DesktopIntegrationFail, NotificationLevel::WarningNotificationLevel, DEFAULT_NOTIFICATION_DURATION_SECONDS,
        _u8L("Desktop integration failed.") },
    {NotificationType::UndoDesktopIntegrationSuccess, NotificationLevel::RegularNotificationLevel, DEFAULT_NOTIFICATION_DURATION_SECONDS,
        _u8L("Undo desktop integration was successful.") },
    {NotificationType::UndoDesktopIntegrationFail, NotificationLevel::WarningNotificationLevel, DEFAULT_NOTIFICATION_DURATION_SECONDS,
    ...
    {NotificationType::URLNotRegistered
        ...
        ,  [](wxEvtHandler* evnthndlr) {
            ...
            //{NotificationType::DeviceEjected, NotificationLevel::RegularNotificationLevel, DEFAULT_NOTIFICATION_DURATION_SECONDS,  _u8L("Removable device has been safely ejected")} // if we want changeble text (like here name of device), we need to do it as CustomNotification
    };
