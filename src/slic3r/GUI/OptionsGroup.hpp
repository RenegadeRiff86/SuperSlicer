...
public:
    ...
    std::shared_ptr<wxSizer> widget_sizer;
    wxSizer*	extra_widget_sizer {nullptr};
    std::shared_ptr<wxSizer> owned_extra_widget_sizer;
    wxSizer*	extra_widget_sizer_parent {nullptr}; // non-owning: h_sizer owns extra_widget_sizer and destroys it in Remove()
