...
inline constexpr int ICON_DECORATION_THRESHOLD = 16;
...
public:
    ...
    std::string icon_name(int icon_size, PrinterTechnology tech) const override { return (icon_size < ICON_DECORATION_THRESHOLD) ? "spool" : "spool_cog"; }
...
class TabPrinter : public Tab
{
    std::string icon_name(int icon_size, PrinterTechnology tech) const override {
        return (tech & ptFFF) != 0 ?
            (icon_size < ICON_DECORATION_THRESHOLD) ? "printer" : "printer_cog" :
            (icon_size < ICON_DECORATION_THRESHOLD) ? "sla_printer" : "sla_printer_cog";
    }
...
public:
    ...
    std::string icon_name(int icon_size, PrinterTechnology tech) const override { return (icon_size < ICON_DECORATION_THRESHOLD) ? "resin" : "resin_cog"; }
