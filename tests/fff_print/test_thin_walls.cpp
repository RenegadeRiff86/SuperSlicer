...
SCENARIO("Medial Axis", "[ThinWalls]") {
    GIVEN("Square with hole") {
        ...
        WHEN("Medial axis is extracted") {
            Polylines res;
            expolygon.medial_axis(scaled<double>(0.5), scaled<double>(40.), res);
    ...
    GIVEN("narrow rectangle") {
        ...
        WHEN("Medial axis is extracted") {
            Polylines res;
            expolygon.medial_axis(scaled<double>(0.5), scaled<double>(20.), res);
    ...
    GIVEN("semicircumference") {
        ...
        WHEN("Medial axis is extracted") {
            Polylines res;
            expolygon.medial_axis(scaled<double>(0.25), scaled<double>(1.324888), res);
    ...
    GIVEN("whatever shape") {
        ...
        WHEN("Medial axis is extracted") {
            Polylines res;
            expolygon.medial_axis(102499.75, 819998., res);
    ...
    GIVEN("narrow triangle") {
        ...
        WHEN("Medial axis is extracted") {
            Polylines res;
            expolygon.medial_axis(scaled<double>(0.5), scaled<double>(4.), res);
    ...
    GIVEN("GH #2474") {
        ...
        WHEN("Medial axis is extracted") {
            Polylines res;
            expolygon.medial_axis(500000, 1871238, res);
            THEN("medial axis is a single line") {
                REQUIRE(res.size() == 1);
            }
