...
TEST_CASE("test clip_clipper_polygon_with_subject_bbox ", "[ClipperUtils]") {
    ...
    SECTION(" src has en edge over the boundary edge")
    {
        ...
        Slic3r::Polygon result({Point{172845342,-8749616},Point{-177855391,-8749601},Point{-177855391,-18668915},Point{-173847350,-18668917},Point{-173847350,-14417785},Point{171185171,-14417798},Point{173847352,-18182674},
            Point{173847352,-65231039},Point{177855393,-65231039},Point{177855393,-15834840}});
    ...
    {
        Slic3r::Polygon scr_poly({Point{15000, 15000},Point{15000,5000},Point{5000,5000},Point{5000,-5000},Point{20000,-5000},Point{20000,20000},Point{-20000,20000},Point{-20000,-5000},Point{-5000,-5000},Point{-5000,5000},
            Point{-15000,5000},Point{-15000,15000}});
        BoundingBox bbox(Points{Point{-10000, -10000}, Point{10000, 10000}});
        Slic3r::Polygon result({Point{5000,-5000},Point{10033,-5000},Point{10033,10033},Point{-10033,10033},Point{-10033,-5000},Point{-5000,-5000},Point{-5000,5000},Point{-10000,5000},Point{-10000,10000},Point{10000,10000},
            Point{10000,5000},Point{5000,5000}});
        //Slic3r::Polygon result({Point{5000,-5000},Point{13000,-5000},Point{13000,13000},Point{-13000,13000},
        //                        Point{-13000,-5000},Point{-5000,-5000},Point{-5000,5000},Point{-10000,5000},
        //                        Point{-10000,10000},Point{10000,10000},Point{10000,5000},Point{5000,5000}});
        //bbox.scale(100);
        //scr_poly.scale(100);
        //result.scale(100);
        Slic3r::Polygon simplified = Slic3r::ClipperUtils::clip_clipper_polygon_with_subject_bbox(scr_poly, bbox);
